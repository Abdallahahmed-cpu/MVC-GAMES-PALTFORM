...
namespace gamesssss.Migrations
{
    ...
    [Migration("20241110200052_AddReviewsToGame")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("gamesssss.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("gamesssss.Models.Device", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("gamesssss.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("gamesssss.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("gamesssss.Models.GameDevice", b =>
                {
                    b.HasOne("gamesssss.Models.Device", "dvice")
                        .WithMany()
            ...
            modelBuilder.Entity("gamesssss.Models.Review", b =>
                {
                    ...
                    b.HasOne("gamesssss.Data.ApplicationUser", "User")
                        .WithMany("Reviews")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
